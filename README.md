...
This simulator is composed of two parts: [TALYS v1.96](https://tendl.web.psi.ch/tendl_2019/talys.html) and original kinematics simulator based on [ROOT](https://root.cern/).  
Note that this simulator reads files that contain branching ratios, which are calculated with TALYS.  
Therefore, the simulator codes themselves are indepdent of TALYS code.
...
You just need to declare "Deexcitation" object and call a function:
```
